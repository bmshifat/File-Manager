<?php
/**
 * BM - veno file manager: admin-panel/view/admin-head-settings.php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    */
    ...
    $postappname = filter_input(INPUT_POST, "appname", FILTER_SANITIZE_STRING);

    $selectivext = filter_input(INPUT_POST, "selectivext", FILTER_SANITIZE_STRING);

    if ($selectivext === "allow") {
        $postupload_allow_type = filter_input(INPUT_POST, "upload_allow_type", FILTER_SANITIZE_STRING);
        $postupload_reject_extension = false;
    } else {
        $selectivext = "reject";
        $postupload_reject_extension = filter_input(INPUT_POST, "upload_reject_extension", FILTER_SANITIZE_STRING);
    ...
    $listview = filter_input(INPUT_POST, "list_view", FILTER_SANITIZE_STRING);
    $postuploademail = filter_input(INPUT_POST, "upload_email", FILTER_SANITIZE_STRING);
    ...
    $txtdir = filter_input(INPUT_POST, "txt_direction", FILTER_SANITIZE_STRING);
    $poststartingdir = filter_input(INPUT_POST, "starting_dir", FILTER_SANITIZE_STRING);
    ...
    $timezone = filter_input(INPUT_POST, "default_timezone", FILTER_SANITIZE_STRING);
    ...
    $ip_list = filter_input(INPUT_POST, "ip_list", FILTER_SANITIZE_STRING);
    $ip_redirect = filter_input(INPUT_POST, "ip_redirect", FILTER_VALIDATE_URL);
    $ip_blacklist = filter_input(INPUT_POST, "ip_blacklist", FILTER_SANITIZE_STRING);
    $ip_whitelist = filter_input(INPUT_POST, "ip_whitelist", FILTER_SANITIZE_STRING);
    ...
    $_CONFIG['recaptcha_site'] = filter_input(INPUT_POST, "recaptcha_site", FILTER_SANITIZE_STRING);

    $_CONFIG['recaptcha_secret'] = filter_input(INPUT_POST, "recaptcha_secret", FILTER_SANITIZE_STRING);
    ...
    $remote_extensions = filter_input(INPUT_POST, 'remote_extensions', FILTER_SANITIZE_STRING);
    ...
    $registration_lifetime = filter_input(INPUT_POST, "registration_lifetime", FILTER_SANITIZE_STRING);
    ...
    $filedeforder = filter_input(INPUT_POST, "filedeforder", FILTER_SANITIZE_STRING);
    ...
    $folderdeforder = filter_input(INPUT_POST, "folderdeforder", FILTER_SANITIZE_STRING);
    ...
    */
    ...
    $remove_email_logo = filter_input(INPUT_POST, "remove_email_logo", FILTER_SANITIZE_STRING);
