<?php
/**
 * BM - veno file manager: ajax/session.php
 *
 * Set session vars
 *
 * PHP version >= 5.3
...
// update list view
$listview = filter_input(INPUT_POST, "listview", FILTER_SANITIZE_STRING);
if ($listview) {
...
$sort_dir_order = filter_input(INPUT_POST, "sort_dir_order", FILTER_SANITIZE_STRING);
