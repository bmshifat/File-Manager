...
if (!class_exists('Logger', false)) {
    ...
    class Logger
    {
         ...
         * @return $message
         */
        public static function log($message, $relpath = 'BM-Admin/')
        {
            if (SetUp::getConfig('log_file') == true) {
                $logjson = $relpath.'_content/log/'.date('Y-m-d').'.json';
                ...
                if (Utils::isFileWritable($logjson)) {
                    ...
                    Utils::setError('The script does not have permissions to write inside "BM-Admin/_content/log" folder. check CHMOD');
                    return;
                }
            }
        }
         ...
         * @param boolean $remote true if called inside BM-Admin
         *
         * @return $message
         */
