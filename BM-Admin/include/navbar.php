<?php
/**
 * BM - veno file manager: include/navbar.php
...
<nav class="navbar navbar-inverse<?php echo $navbarclass; ?>">
    <div class="container">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#collapse-BM-menu">
        ...
        <div class="collapse navbar-collapse" id="collapse-BM-menu">
...
if ($gateKeeper->isUserLoggedIn()) {
    ...
    if ($gateKeeper->isSuperAdmin()) { ?>
                <li>
                    <a href="<?php echo $setUp->getConfig("script_url"); ?>BM-Admin/">
...
if ($gateKeeper->isUserLoggedIn() && $setUp->getConfig("show_usermenu") == true ) { 
    ...
    */
    $customfields = false;
    if (file_exists('BM-Admin/users/customfields.php')) {
        include 'BM-Admin/users/customfields.php';
    } ?>
    <script type="text/javascript">
    $(document).ready(function(){
