<?php
/**
 * BM - veno file manager: include/load-js.php
...
if (($gateKeeper->isAccessAllowed() && $setUp->getConfig("playmusic") === true) || $setUp->getConfig('share_playmusic') === true) {
    if ($debug_mode === true) {
        ?>
    <script src="BM-Admin/js/soundmanager/soundmanager2.js?v=2.97"></script>
    <script src="BM-Admin/js/soundmanager/BM-inlineplayer.js?v=2.97"></script>
        <?php
    } else {
        ?>
    <script src="BM-Admin/js/soundmanager/soundmanager2.min.js?v=2.97"></script>
        <?php
    }
}

if ($debug_mode === true) { ?>
    <script type="text/javascript" src="BM-Admin/js/modernizr.js"></script>    
    <script type="text/javascript" src="BM-Admin/js/bootbox.js"></script>    
    <script type="text/javascript" src="BM-Admin/js/app.js?v=<?php echo $vfm_version; ?>"></script>
    <?php
} else { ?>
    <script type="text/javascript" src="BM-Admin/js/app.min.js?v=<?php echo $vfm_version; ?>"></script>
    <?php
} ?> 
<script type="text/javascript" src="BM-Admin/js/bootstrap.min.js?v=3.3.7"></script>
<script type="text/javascript">
    // confirm
    bootbox.addLocale('BM', 
    {
        OK : '<?php echo $setUp->getString("OK"); ?>',
        CANCEL : '<?php echo $setUp->getString("CANCEL"); ?>',
        CONFIRM : '<?php echo $setUp->getString("CONFIRM"); ?>'
    });
    bootbox.setLocale('BM');
</script>
<?php
if ($gateKeeper->isUserLoggedIn()) : ?>
    <script type="text/javascript" src="BM-Admin/js/avatars.js?v=<?php echo $vfm_version; ?>"></script>
    <?php
endif;

if ($gateKeeper->isAccessAllowed()) : 
    ?>
    <script type="text/javascript" src="BM-Admin/js/datatables.min.js?v=1.10.16"></script>
    <?php
    /**
     * Setup Files Table
     */
