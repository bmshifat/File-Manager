<?php
/**
 * BM - veno file manager: include/modals.php
 * popup windows
 *
 * PHP version >= 5.3
 *
...
if ($gateKeeper->isAccessAllowed()) {
    ...
    if ($gateKeeper->isAllowed('sendfiles_enable') && $gateKeeper->isAllowed('download_enable')) { ?>
        ...
        if ($setUp->getConfig('clipboard')) { ?>
                                <script type="text/javascript" src="BM-Admin/js/clipboard.min.js"></script>
                                <script type="text/javascript">
...
<script type="text/javascript">
    ...
    var baselink = "BM-Admin/BM-downloader.php?q=";
        <?php
    } ?>
</script>
    ...
    if ($setUp->getConfig('playvideo') === true) : 
        ...
        ?>
    <link href="BM-Admin/js/videojs/video-js.min.css" rel="stylesheet">
    <script src="BM-Admin/js/videojs/video.min.js?v=7.4.1"></script>
    <script src="BM-Admin/js/videojs/lang/<?php echo $playerlang; ?>.js"></script>
    <script type="text/javascript">
    ...
    */ 
    ...
    function loadImg(thislink, thislinkencoded, thisname, thisID, ext){
        $(".BM-zoom").html("<i class=\"fa fa-refresh fa-spin\"></i><img class=\"preimg\" src=\"BM-thumb.php?thumb="+ thislink +"&y=1\" \/>");
        $("#zoomview").data('id', thisID);
        $("#zoomview .thumbtitle").val(thisname);
        var firstImg = $('.preimg');
