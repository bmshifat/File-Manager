<?php
/**
 * BM - veno file manager: include/register.php
...
if (!$gateKeeper->isUserLoggedIn()) {
    ...
    */
    if ($setUp->getConfig("registration_enable") == true) { ?>
                        ...
                        <form id="regform" action="<?php print $location->makeLink(false, null, ""); ?>">
                            ...
                            <div id="login_bar" class="form-group">
                                ...
                                */
                                ...
                                <?php
                                $disclaimerfile = 'BM-Admin/registration-disclaimer.html';
        ...
        <script type="text/javascript" src="BM-Admin/js/registration.min.js"></script>
