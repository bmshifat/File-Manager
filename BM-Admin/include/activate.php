<?php
/**
 * BM - veno file manager: include/activate.php
...
if ($regactive && $setUp->getConfig("registration_enable") == true) :
    ...
    if (file_exists('BM-Admin/users/users-new.php')) {
        include 'BM-Admin/users/users-new.php';
        ...
        if ($newuser !== false) {
            ...
            if ($updater->updateRegistrationFile($newusers, 'BM-Admin/users/')) {
